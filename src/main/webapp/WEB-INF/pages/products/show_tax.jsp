...
<head>
    <meta charset="utf-8">
    <title><spring:message code="show_tax.title"/> | <spring:message code="application.name"/></title>
...
<div id="wrap">
    ...
    <div class="container">
        <h3><spring:message code="show_tax.container.title"/></h3>

        <p><spring:message code="show_tax.introtext"/></p>
        <div class="row">
            <div class="col-xs-6">
                <div class="form-group">
                    <div class="control-label"><b><spring:message code="label.impuesto.idImpuesto"/></b></div>
                    <div class="control-label">${impuesto.idImpuesto}</div>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="form-group">
                    <div class="control-label"><b><spring:message code="label.impuesto.nombre"/></b></div>
                    <div class="control-label">${impuesto.nombre}</div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-6">
                <div class="form-group">
                    <div class="control-label"><b><spring:message code="label.impuesto.porcentaje"/></b></div>
                    <div class="control-label">${impuesto.porcentaje}</div>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="form-group">
                    <div class="control-label"><b><spring:message code="label.impuesto.estado"/></b></div>
                    <div class="control-label">${impuesto.estado.getEstado()}</div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <div class="form-group">
                    <div class="control-label"><b><spring:message code="label.impuesto.descripcion"/></b></div>
                    <div class="control-label">${impuesto.descripcion}</div>
                </div>
            </div>
        </div>
    </div>
